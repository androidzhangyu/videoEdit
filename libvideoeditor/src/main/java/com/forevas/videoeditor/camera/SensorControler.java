...
public class SensorControler implements SensorEventListener {
    ...
    private SensorControler() {
        mSensorManager = (SensorManager) VideoEditorSDK.getInstance().getContext().getSystemService(Activity.SENSOR_SERVICE);
        mSensor = mSensorManager != null ? mSensorManager.getDefaultSensor(Sensor.TYPE_ACCELEROMETER) : null;// TYPE_GRAVITY
    }
    ...
    public void registCameraFocusListener(CameraFocusListener mCameraFocusListener) {
        this.mCameraFocusListener = mCameraFocusListener;
    }

    public void unregistCameraFocusListener() {
