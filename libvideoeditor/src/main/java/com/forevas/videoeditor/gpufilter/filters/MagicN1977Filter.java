...
public class MagicN1977Filter extends GPUImageFilter {
	...
	protected void onInitialized(){
	    ...
	    runOnDraw(new Runnable(){
		    public void run(){
		    	inputTextureHandles[0] = OpenGlUtils.loadTexture(VideoEditorSDK.getInstance().getContext(), "filter/n1977map.png");
				inputTextureHandles[1] = OpenGlUtils.loadTexture(VideoEditorSDK.getInstance().getContext(), "filter/n1977blowout.png");
		    }
	    });
	}
}
