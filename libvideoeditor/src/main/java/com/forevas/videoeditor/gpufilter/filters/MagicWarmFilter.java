	...
	public void onInitialized(){
	    ...
	    runOnDraw(new Runnable(){
		    public void run(){
		        ...
		        mMaskGrey1TextureId = OpenGlUtils.loadTexture(VideoEditorSDK.getInstance().getContext(), "filter/warm_layer1.jpg");
		        mMaskGrey2TextureId = OpenGlUtils.loadTexture(VideoEditorSDK.getInstance().getContext(), "filter/bluevintage_mask1.jpg");
		    }
	    });
	}
}
