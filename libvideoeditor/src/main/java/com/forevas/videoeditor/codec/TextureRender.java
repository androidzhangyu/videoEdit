...
//    };
    ...
    public TextureRender(VideoInfo info) {
        ...
        mShow = new NoFilter(VideoEditorSDK.getInstance().getContext().getResources());
        mShow.setMatrix(MatrixUtils.flip(MatrixUtils.getOriginalMatrix(), false, true));
        rotationFilter = new RotationOESFilter(VideoEditorSDK.getInstance().getContext().getResources());
    }
