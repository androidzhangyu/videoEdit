...
import com.forevas.videoeditor.encoder.gles.EglCore;
...
import com.forevas.videoeditor.gpufilter.basefilter.MagicCameraInputFilter;
...
public class TextureMovieEncoder implements Runnable {
    ...
    private String mVideoPath;//作为视频的标识
...
//        }
    ...
    private void handleStopRecording() {
        ...
        releaseEncoder();
        System.out.println("testRecordStatus postEvent"+mVideoPath);
        EventBus.getDefault().post(new RecordSegFinishEvent(mVideoPath,true));
    }
    ...
    private AFilter mShowFilter=new NoFilter(VideoEditorSDK.getInstance().getContext().getResources());
